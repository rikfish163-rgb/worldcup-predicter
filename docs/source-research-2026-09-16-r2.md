...
- 生成时间：`2026-09-15T21:50:43.451300+00:00`（由调用方显式传入）
- 快照 `as_of`：`2026-09-15T21:42:50.038371+00:00`
- 快照 SHA-256：`62ef79fabb6f6ab2a06df4682878f1a913feac259d2643f385033a39e3833662`
- 覆盖来源数：`47`
...
|---|---|---|---:|---:|---|---|---|
| bundesliga_public_pages | first_party_access_reuse_terms_not_verified | rights_blocked | not opened | — | blocked_pending_terms_review | blocked | blocked |
...
| crawl4ai_allowlisted_pages | execution_layer_not_fact_source | rights_blocked | not opened | — | conditional_per_declared_page | blocked_by_default | blocked_by_default |
...
| laliga_official_news | first_party_access_reuse_terms_not_verified | rights_blocked | not opened | — | blocked_pending_terms_review | blocked | blocked |
| laliga_public_pages | first_party_access_reuse_terms_not_verified | rights_blocked | not opened | — | blocked_pending_terms_review | blocked | blocked |
...
| ligue1_official_news | first_party_access_reuse_terms_not_verified | rights_blocked | not opened | — | blocked_pending_terms_review | blocked | blocked |
| met_norway_weather | verified_cc_by_forecast_with_identifying_user_agent | degraded | opened | 1 | allowed_with_attribution | conditional_exact_coordinates_and_time | conditional_with_attribution |
| oddstorm_market_comparison | provider_permission_required | rights_blocked | not opened | — | blocked | blocked | blocked |
| oddstorm_market_history | provider_permission_required | not_observed | not opened | — | blocked | blocked | blocked |
| official_bundesliga_lineups | first_party_access_reuse_terms_not_verified | not_observed | not opened | — | blocked_pending_terms_review | blocked | blocked |
| official_laliga_lineups | first_party_access_reuse_terms_not_verified | not_observed | not opened | — | blocked_pending_terms_review | blocked | blocked |
...
| official_ligue1_lineups | first_party_access_reuse_terms_not_verified | not_observed | not opened | — | blocked_pending_terms_review | blocked | blocked |
| official_premier_league_lineups | first_party_access_reuse_terms_not_verified | not_observed | not opened | — | blocked_pending_terms_review | blocked | blocked |
| official_serie_a_lineups | first_party_access_reuse_terms_not_verified | not_observed | not opened | — | blocked_pending_terms_review | blocked | blocked |
| open_meteo | rights_unverified | rights_blocked | not opened | — | blocked_pending_rights_review | blocked | blocked |
| open_meteo_geocoding | free_tier_noncommercial_cc_by_only | not_observed | not opened | — | blocked_for_current_commercial_release | blocked_pending_commercial_plan | blocked_pending_commercial_plan |
| open_meteo_weather | free_tier_noncommercial_cc_by_only | not_observed | not opened | — | blocked_for_current_commercial_release | blocked_pending_commercial_plan | blocked_pending_commercial_plan |
...
| premier_league_public_pages | first_party_access_reuse_terms_not_verified | rights_blocked | not opened | — | blocked_pending_terms_review | blocked | blocked |
| public_rss_news | rights_unverified | rights_blocked | not opened | — | blocked_pending_rights_review | blocked | blocked |
| seriea_public_pages | first_party_access_reuse_terms_not_verified | rights_blocked | not opened | — | blocked_pending_terms_review | blocked | blocked |
...
| whoscored_public_pages | rights_unverified | rights_blocked | not opened | — | blocked_pending_rights_review | blocked | blocked |
| wikidata_entities | verified_cc0_structured_data | degraded | opened | 1 | allowed_with_attribution_preference | conditional_exact_venue_chain | conditional_with_provenance |
...
- 时间：observed_at is mandatory; missing effective time is explicitly non-model and non-publication
- 原始哈希：`{"algorithm": "SHA-256", "deduplicate": "same raw bytes deduplicated; conflicting payloads retained", "missing_hash_meaning": "not_recorded_by_adapter_or_no_payload; never infer a hash", "observed_hash_count": 0, "observed_hashes": [], "observed_hashes_truncated": false, "required": true}`
- 实际 HTTP/运行：`{"attempted": false, "content_type_observation": "not_recorded_by_adapter", "content_types": [], "error_count": 0, "errors": [], "evidence": ["snapshot.runtime.cfl_official_current"], "network_opened": false, "raw_hash_count": 0, "raw_hashes": [], "raw_hashes_truncated": false, "record_count": null, "reported_record_count": 0, "state": "not_attempted", "status": "rights_blocked", "status_codes": []}`
- 状态/失败：`{"reason": "runtime preserved an explicit policy/quarantine block", "runtime_error_count": 0, "runtime_errors": [], "runtime_key": null, "state": "rights_blocked"}`
- 替代方案：OpenFootball for exact fixture/result facts; obtain a documented license or keep this field unavailable
...
- 时间：observed_at is mandatory; missing effective time is explicitly non-model and non-publication
- 原始哈希：`{"algorithm": "SHA-256", "deduplicate": "same raw bytes deduplicated; conflicting payloads retained", "missing_hash_meaning": "not_recorded_by_adapter_or_no_payload; never infer a hash", "observed_hash_count": 0, "observed_hashes": [], "observed_hashes_truncated": false, "required": true}`
- 实际 HTTP/运行：`{"attempted": false, "content_type_observation": "not_recorded_by_adapter", "content_types": [], "error_count": 0, "errors": [], "evidence": ["snapshot.runtime.crawl4ai_allowlisted_pages"], "network_opened": false, "raw_hash_count": 0, "raw_hashes": [], "raw_hashes_truncated": false, "record_count": null, "reported_record_count": 0, "state": "not_attempted", "status": "rights_blocked", "status_codes": []}`
- 状态/失败：`{"reason": "runtime preserved an explicit policy/quarantine block", "runtime_error_count": 0, "runtime_errors": [], "runtime_key": null, "state": "rights_blocked"}`
- 替代方案：OpenFootball for exact fixture/result facts; obtain a documented license or keep this field unavailable
...
- 原始哈希：`{"algorithm": "SHA-256", "deduplicate": "same raw bytes deduplicated; conflicting payloads retained", "missing_hash_meaning": "not_recorded_by_adapter_or_no_payload; never infer a hash", "observed_hash_count": 0, "observed_hashes": [], "observed_hashes_truncated": false, "required": true}`
- 实际 HTTP/运行：`{"attempted": false, "content_type_observation": "not_recorded_by_adapter", "content_types": [], "error_count": 0, "errors": [], "evidence": ["snapshot.runtime.espn_injury_reports"], "network_opened": false, "raw_hash_count": 0, "raw_hashes": [], "raw_hashes_truncated": false, "record_count": null, "reported_record_count": 0, "state": "not_attempted", "status": "rights_blocked", "status_codes": []}`
- 状态/失败：`{"reason": "runtime preserved an explicit policy/quarantine block", "runtime_error_count": 0, "runtime_errors": [], "runtime_key": null, "state": "rights_blocked"}`
...
- 时间：observed_at must precede kickoff/freeze cutoff for model use; publication/effective time is not inferred from request time
- 原始哈希：`{"algorithm": "SHA-256", "deduplicate": "same raw bytes deduplicated; conflicting payloads retained", "missing_hash_meaning": "not_recorded_by_adapter_or_no_payload; never infer a hash", "observed_hash_count": 0, "observed_hashes": [], "observed_hashes_truncated": false, "required": true}`
- 实际 HTTP/运行：`{"attempted": false, "content_type_observation": "not_recorded_by_adapter", "content_types": [], "error_count": 0, "errors": [], "evidence": ["snapshot.runtime.espn_market_summary"], "network_opened": false, "raw_hash_count": 0, "raw_hashes": [], "raw_hashes_truncated": false, "record_count": null, "reported_record_count": 0, "state": "not_attempted", "status": "rights_blocked", "status_codes": []}`
- 状态/失败：`{"reason": "runtime preserved an explicit policy/quarantine block", "runtime_error_count": 0, "runtime_errors": [], "runtime_key": null, "state": "rights_blocked"}`
- 替代方案：Licensed sports-data provider or first-party permission; OpenFootball remains fixture/result authority
- Eligibility：display=`blocked`，model=`blocked`，publication=`blocked`
...
- 时间：observed_at must precede kickoff/freeze cutoff for model use; publication/effective time is not inferred from request time
- 原始哈希：`{"algorithm": "SHA-256", "deduplicate": "same raw bytes deduplicated; conflicting payloads retained", "missing_hash_meaning": "not_recorded_by_adapter_or_no_payload; never infer a hash", "observed_hash_count": 0, "observed_hashes": [], "observed_hashes_truncated": false, "required": true}`
- 实际 HTTP/运行：`{"attempted": false, "content_type_observation": "not_recorded_by_adapter", "content_types": [], "error_count": 0, "errors": [], "evidence": ["snapshot.runtime.espn_schedule_summary"], "network_opened": false, "raw_hash_count": 0, "raw_hashes": [], "raw_hashes_truncated": false, "record_count": null, "reported_record_count": 0, "state": "not_attempted", "status": "rights_blocked", "status_codes": []}`
- 状态/失败：`{"reason": "runtime preserved an explicit policy/quarantine block", "runtime_error_count": 0, "runtime_errors": [], "runtime_key": null, "state": "rights_blocked"}`
- 替代方案：Licensed sports-data provider or first-party permission; OpenFootball remains fixture/result authority
- Eligibility：display=`blocked`，model=`blocked`，publication=`blocked`
...
- 时间：observed_at must precede kickoff/freeze cutoff for model use; publication/effective time is not inferred from request time
- 原始哈希：`{"algorithm": "SHA-256", "deduplicate": "same raw bytes deduplicated; conflicting payloads retained", "missing_hash_meaning": "not_recorded_by_adapter_or_no_payload; never infer a hash", "observed_hash_count": 0, "observed_hashes": [], "observed_hashes_truncated": false, "required": true}`
- 实际 HTTP/运行：`{"attempted": false, "content_type_observation": "not_recorded_by_adapter", "content_types": [], "error_count": 0, "errors": [], "evidence": ["snapshot.runtime.espn_team_rosters"], "network_opened": false, "raw_hash_count": 0, "raw_hashes": [], "raw_hashes_truncated": false, "record_count": null, "reported_record_count": 0, "state": "not_attempted", "status": "rights_blocked", "status_codes": []}`
- 状态/失败：`{"reason": "runtime preserved an explicit policy/quarantine block", "runtime_error_count": 0, "runtime_errors": [], "runtime_key": null, "state": "rights_blocked"}`
- 替代方案：Licensed sports-data provider or first-party permission; OpenFootball remains fixture/result authority
- Eligibility：display=`blocked`，model=`blocked`，publication=`blocked`
...
- 时间：observed_at is mandatory; missing effective time is explicitly non-model and non-publication
- 原始哈希：`{"algorithm": "SHA-256", "deduplicate": "same raw bytes deduplicated; conflicting payloads retained", "missing_hash_meaning": "not_recorded_by_adapter_or_no_payload; never infer a hash", "observed_hash_count": 0, "observed_hashes": [], "observed_hashes_truncated": false, "required": true}`
- 实际 HTTP/运行：`{"attempted": false, "content_type_observation": "not_recorded_by_adapter", "content_types": [], "error_count": 0, "errors": [], "evidence": ["snapshot.runtime.fotmob_public_api"], "network_opened": false, "raw_hash_count": 0, "raw_hashes": [], "raw_hashes_truncated": false, "record_count": null, "reported_record_count": 0, "state": "not_attempted", "status": "blocked_by_robots", "status_codes": []}`
...
- 时间：observed_at is mandatory; missing effective time is explicitly non-model and non-publication
- 原始哈希：`{"algorithm": "SHA-256", "deduplicate": "same raw bytes deduplicated; conflicting payloads retained", "missing_hash_meaning": "not_recorded_by_adapter_or_no_payload; never infer a hash", "observed_hash_count": 0, "observed_hashes": [], "observed_hashes_truncated": false, "required": true}`
- 实际 HTTP/运行：`{"attempted": false, "content_type_observation": "not_recorded_by_adapter", "content_types": [], "error_count": 1, "errors": [{"error": "match_directory_diagnostic_missing"}], "evidence": ["snapshot.runtime.laliga_official_match_directory"], "network_opened": false, "raw_hash_count": 0, "raw_hashes": [], "raw_hashes_truncated": false, "record_count": null, "reported_record_count": 0, "state": "not_attempted", "status": "unavailable", "status_codes": []}`
- 状态/失败：`{"reason": "runtime payload or diagnostics are present; see errors and coverage", "runtime_error_count": 1, "runtime_errors": [{"error": "match_directory_diagnostic_missing"}], "runtime_key": null, "state": "unavailable"}`
- 替代方案：OpenFootball for exact fixture/result facts; obtain a documented license or keep this field unavailable
- Eligibility：display=`blocked_pending_rights_review`，model=`blocked`，publication=`blocked`
...
- Parser：`league_platform.live_sources.met_norway`；声明字段：`forecast_at, temperature_c, humidity_percent, wind_speed_mps, precipitation_mm, symbol_code`；已观测：`forecast_at, humidity_percent, precipitation_mm, symbol_code, temperature_c, wind_speed_mps`；缺失：`无`
...
- 原始哈希：`{"algorithm": "SHA-256", "deduplicate": "same raw bytes deduplicated; conflicting payloads retained", "missing_hash_meaning": "not_recorded_by_adapter_or_no_payload; never infer a hash", "observed_hash_count": 5, "observed_hashes": ["2535cdefe10b8b9dab51915728d0b1710b6198f1c8a7d55f38c25029405012b6", "2ae2c3ab7c3e09e503dda84a3a309369b340200fd3ce6503d903b83098d7c24d", "4dae057565bdad83783710a03e32066d04bc5ecc7b72380047b9365fdb0a11fc", "6a3a43b69eeb3f4f5d99ffd0d2aa7ac9d6b11b317ff3696a7fab9d23ff94e034", "b34066e0e9a7783a15b712bb581a26189157650dd41b745e4e4c197caa311f61"], "observed_hashes_truncated": false, "required": true}`
- 实际 HTTP/运行：`{"adapter_run": {"final_url": "https://api.met.no/weatherapi/locationforecast/2.0/compact?lat=40.4361&lon=-3.5994", "record_count": 1, "request_count": 1, "user_agent": "MatchlineResearch/1.0 (+https://predict.hetaisheng.ccwu.cc)"}, "attempted": true, "content_bytes": 40072, "content_encoding": null, "content_sha256": "4dae057565bdad83783710a03e32066d04bc5ecc7b72380047b9365fdb0a11fc", "content_types": ["application/json"], "error_count": 0, "evidence": ["https://api.met.no/weatherapi/locationforecast/2.0/compact?lat=40.4361&lon=-3.5994"], "network_opened": true, "raw_hash_count": 5, "raw_hashes": ["2535cdefe10b8b9dab51915728d0b1710b6198f1c8a7d55f38c25029405012b6", "2ae2c3ab7c3e09e503dda84a3a309369b340200fd3ce6503d903b83098d7c24d", "4dae057565bdad83783710a03e32066d04bc5ecc7b72380047b9365fdb0a11fc", "6a3a43b69eeb3f4f5d99ffd0d2aa7ac9d6b11b317ff3696a7fab9d23ff94e034", "b34066e0e9a7783a15b712bb581a26189157650dd41b745e4e4c197caa311f61"], "raw_hashes_truncated": false, "record_count": 1, "request_started_at": "2026-09-15T21:50:42.370609+00:00", "response_observed_at": "2026-09-15T21:50:43.451300+00:00", "source_id": "met_norway_weather", "state": "success", "status": "ok", "status_codes": [200], "wire_bytes": 40072, "wire_sha256": "4dae057565bdad83783710a03e32066d04bc5ecc7b72380047b9365fdb0a11fc"}`
- 状态/失败：`{"reason": "runtime payload or diagnostics are present; see errors and coverage; dated operator probe admitted a valid response but runtime diagnostics remain authoritative", "runtime_error_count": 79, "runtime_errors": [{"count": 63, "reason": "venue_coordinates_missing"}, {"count": 16, "reason": "additional_errors_omitted"}], "runtime_key": "met_norway_weather", "state": "degraded"}`
...
- 时间：quote observed_at and settlement line are mandatory; stale/history rows cannot become current odds
- 原始哈希：`{"algorithm": "SHA-256", "deduplicate": "same raw bytes deduplicated; conflicting payloads retained", "missing_hash_meaning": "not_recorded_by_adapter_or_no_payload; never infer a hash", "observed_hash_count": 0, "observed_hashes": [], "observed_hashes_truncated": false, "required": true}`
- 实际 HTTP/运行：`{"attempted": false, "content_type_observation": "not_recorded_by_adapter", "content_types": [], "error_count": 0, "errors": [], "evidence": ["snapshot.runtime.oddstorm_market_comparison"], "network_opened": false, "raw_hash_count": 0, "raw_hashes": [], "raw_hashes_truncated": false, "record_count": null, "reported_record_count": 0, "state": "not_attempted", "status": "rights_blocked", "status_codes": []}`
- 状态/失败：`{"reason": "runtime preserved an explicit policy/quarantine block", "runtime_error_count": 0, "runtime_errors": [], "runtime_key": null, "state": "rights_blocked"}`
- 替代方案：Licensed market feed with explicit redistribution/settlement rights; otherwise market baseline stays unavailable
- Eligibility：display=`blocked`，model=`blocked`，publication=`blocked`
...
- 时间：observed_at is mandatory; missing effective time is explicitly non-model and non-publication
- 原始哈希：`{"algorithm": "SHA-256", "deduplicate": "same raw bytes deduplicated; conflicting payloads retained", "missing_hash_meaning": "not_recorded_by_adapter_or_no_payload; never infer a hash", "observed_hash_count": 0, "observed_hashes": [], "observed_hashes_truncated": false, "required": true}`
- 实际 HTTP/运行：`{"attempted": false, "content_type_observation": "not_recorded_by_adapter", "content_types": [], "error_count": 0, "errors": [], "evidence": ["snapshot.runtime.public_rss_news"], "network_opened": false, "raw_hash_count": 0, "raw_hashes": [], "raw_hashes_truncated": false, "record_count": null, "reported_record_count": 0, "state": "not_attempted", "status": "rights_blocked", "status_codes": []}`
- 状态/失败：`{"reason": "runtime preserved an explicit policy/quarantine block", "runtime_error_count": 0, "runtime_errors": [], "runtime_key": null, "state": "rights_blocked"}`
- 替代方案：OpenFootball for exact fixture/result facts; obtain a documented license or keep this field unavailable
- Eligibility：display=`blocked_pending_rights_review`，model=`blocked`，publication=`blocked`
...
- 时间：observed_at is mandatory; missing effective time is explicitly non-model and non-publication
- 原始哈希：`{"algorithm": "SHA-256", "deduplicate": "same raw bytes deduplicated; conflicting payloads retained", "missing_hash_meaning": "not_recorded_by_adapter_or_no_payload; never infer a hash", "observed_hash_count": 0, "observed_hashes": [], "observed_hashes_truncated": false, "required": true}`
- 实际 HTTP/运行：`{"attempted": false, "content_type_observation": "not_recorded_by_adapter", "content_types": [], "error_count": 0, "errors": [], "evidence": ["snapshot.runtime.sofascore_prematch"], "network_opened": false, "raw_hash_count": 0, "raw_hashes": [], "raw_hashes_truncated": false, "record_count": null, "reported_record_count": 0, "state": "not_attempted", "status": "rights_blocked", "status_codes": []}`
- 状态/失败：`{"reason": "runtime preserved an explicit policy/quarantine block", "runtime_error_count": 0, "runtime_errors": [], "runtime_key": null, "state": "rights_blocked"}`
- 替代方案：OpenFootball for exact fixture/result facts; obtain a documented license or keep this field unavailable
- Eligibility：display=`blocked_pending_rights_review`，model=`blocked`，publication=`blocked`
...
- 时间：quote observed_at and settlement line are mandatory; stale/history rows cannot become current odds
- 原始哈希：`{"algorithm": "SHA-256", "deduplicate": "same raw bytes deduplicated; conflicting payloads retained", "missing_hash_meaning": "not_recorded_by_adapter_or_no_payload; never infer a hash", "observed_hash_count": 0, "observed_hashes": [], "observed_hashes_truncated": false, "required": true}`
- 实际 HTTP/运行：`{"attempted": false, "content_type_observation": "not_recorded_by_adapter", "content_types": [], "error_count": 0, "errors": [], "evidence": ["snapshot.runtime.sports_lottery_official"], "network_opened": false, "raw_hash_count": 0, "raw_hashes": [], "raw_hashes_truncated": false, "record_count": null, "reported_record_count": 0, "state": "not_attempted", "status": "rights_blocked", "status_codes": []}`
- 状态/失败：`{"reason": "runtime preserved an explicit policy/quarantine block", "runtime_error_count": 0, "runtime_errors": [], "runtime_key": null, "state": "rights_blocked"}`
- 替代方案：Licensed market feed with explicit redistribution/settlement rights; otherwise market baseline stays unavailable
- Eligibility：display=`blocked_pending_rights_review`，model=`blocked`，publication=`blocked`
...
- 时间：observed_at is mandatory; missing effective time is explicitly non-model and non-publication
- 原始哈希：`{"algorithm": "SHA-256", "deduplicate": "same raw bytes deduplicated; conflicting payloads retained", "missing_hash_meaning": "not_recorded_by_adapter_or_no_payload; never infer a hash", "observed_hash_count": 0, "observed_hashes": [], "observed_hashes_truncated": false, "required": true}`
- 实际 HTTP/运行：`{"attempted": false, "content_type_observation": "not_recorded_by_adapter", "content_types": [], "error_count": 0, "errors": [], "evidence": ["snapshot.runtime.understat_xg"], "network_opened": false, "raw_hash_count": 0, "raw_hashes": [], "raw_hashes_truncated": false, "record_count": null, "reported_record_count": 0, "state": "not_attempted", "status": "rights_blocked", "status_codes": []}`
- 状态/失败：`{"reason": "runtime preserved an explicit policy/quarantine block", "runtime_error_count": 0, "runtime_errors": [], "runtime_key": null, "state": "rights_blocked"}`
- 替代方案：Use OpenFootball historical/current facts or obtain provider permission; do not bypass robots/WAF/TLS policy
- Eligibility：display=`blocked_pending_rights_review`，model=`blocked`，publication=`blocked`
...
- Parser：`league_platform.live_sources.wikidata`；声明字段：`team_entity_id, preferred_venue_entity_id, venue_name, latitude, longitude`；已观测：`latitude, longitude, preferred_venue_entity_id, team_entity_id, venue_name`；缺失：`无`
- 实体联结：team name search -> one senior club entity -> preferred home venue -> valid coordinates; ties quarantined
- 时间：retrieved_at is the observation clock; coordinates are not time-varying match facts and remain field-level provenance
- 原始哈希：`{"algorithm": "SHA-256", "deduplicate": "same raw bytes deduplicated; conflicting payloads retained", "missing_hash_meaning": "not_recorded_by_adapter_or_no_payload; never infer a hash", "observed_hash_count": 5, "observed_hashes": ["0d9de26a0480268729d6c6b055785ab4ce4e104b3c978075ee5b43f8902c8e00", "518ff4b174ceff21bb71e268d98766f278b43f819fc77d79ccdf69954592dfe0", "5c7531e8eb1c6d70e4ed47fc0b19c92df260992e4822932c142a9b2dac2cd38d", "c4f2d6e9e6b124639f5f7edfece6db6aea66617aea591d9636123a2206f971e2", "ec349530747d97d4ad7963f5f977c3a3a9b4c891fcbe18e79ded3248ff295068"], "observed_hashes_truncated": false, "required": true}`
- 实际 HTTP/运行：`{"adapter_run": {"final_url": "https://www.wikidata.org/w/api.php?action=wbgetentities&ids=Q1369687&props=claims%7Clabels%7Cdescriptions&languages=en&format=json", "record_count": 1, "request_count": 1, "user_agent": "MatchlineResearch/1.0 (+https://predict.hetaisheng.ccwu.cc)"}, "attempted": true, "content_bytes": 27910, "content_encoding": null, "content_sha256": "518ff4b174ceff21bb71e268d98766f278b43f819fc77d79ccdf69954592dfe0", "content_types": ["application/json; charset=utf-8"], "error_count": 0, "evidence": ["https://www.wikidata.org/w/api.php?action=wbgetentities&ids=Q1369687&props=claims%7Clabels%7Cdescriptions&languages=en&format=json"], "network_opened": true, "raw_hash_count": 5, "raw_hashes": ["0d9de26a0480268729d6c6b055785ab4ce4e104b3c978075ee5b43f8902c8e00", "518ff4b174ceff21bb71e268d98766f278b43f819fc77d79ccdf69954592dfe0", "5c7531e8eb1c6d70e4ed47fc0b19c92df260992e4822932c142a9b2dac2cd38d", "c4f2d6e9e6b124639f5f7edfece6db6aea66617aea591d9636123a2206f971e2", "ec349530747d97d4ad7963f5f977c3a3a9b4c891fcbe18e79ded3248ff295068"], "raw_hashes_truncated": false, "record_count": 1, "request_started_at": "2026-09-15T21:50:32.799127+00:00", "response_observed_at": "2026-09-15T21:50:42.370501+00:00", "source_id": "wikidata_entities", "state": "success", "status": "ok", "status_codes": [200], "wire_bytes": 27910, "wire_sha256": "518ff4b174ceff21bb71e268d98766f278b43f819fc77d79ccdf69954592dfe0"}`
- 状态/失败：`{"reason": "runtime payload or diagnostics are present; see errors and coverage; dated operator probe admitted a valid response but runtime diagnostics remain authoritative", "runtime_error_count": 2, "runtime_errors": [{"count": 1, "reason": "team_entity_ambiguous"}, {"count": 1, "reason": "wikidata_request_budget_exhausted"}], "runtime_key": "wikidata_entities", "state": "degraded"}`
- 替代方案：Use the other permitted CC0/CC-BY lane only for its own fields; keep missing venue/weather explicit
