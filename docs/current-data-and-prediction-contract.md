...
意甲 50、法甲 45、中超 32；Understat 返回 96 支五大联赛球队的最近 xG/状态；并发检查最近
120 场 fixture 后得到 49 条 DraftKings 1X2 市场快照，六联赛都有部分覆盖，三个抓取通道错误数均为 0。
...
当前输出属于 `research_only`。每场比赛分别披露市场覆盖；没有市场时同时阻断市场与阵容门禁，
有市场时仍因确认首发/伤停缺失而阻断。任何情况都不能形成投注金额或收益建议。
